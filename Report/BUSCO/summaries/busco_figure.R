...
# Output
my_output <- paste("~/Documents/GitHub/Hybryd_Haliotis/Report/BUSCO/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('mammalia', 'mammalia', 'mammalia', 'mammalia', 'eukaryota', 'eukaryota', 'eukaryota', 'eukaryota', 'mollusca', 'mollusca', 'mollusca', 'mollusca', 'bacteria', 'bacteria', 'bacteria', 'bacteria', 'metazoa', 'metazoa', 'metazoa', 'metazoa')
my_species <- factor(my_species)
my_species <- factor(my_species,levels(my_species)[rev(c(2,5,1,3,4))]) # reorder your species here just by changing the values in the vector :
my_percentage <- c(4.6, 10.5, 0.7, 84.2, 27.8, 66.3, 0.8, 5.1, 18.7, 52.0, 1.7, 27.6, 1.6, 5.6, 3.2, 89.6, 19.7, 71.1, 1.4, 7.8)
my_values <- c(422, 972, 67, 7765, 71, 169, 2, 13, 990, 2753, 89, 1463, 2, 7, 4, 111, 188, 678, 13, 75)
